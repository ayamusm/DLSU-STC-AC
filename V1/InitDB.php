<html>
	<head>
		<meta charset="utf-8" />
			...
			<title>DLSU STC AC - Initialized Database</title>
	...
	<body>
		...
		<?php
			...
			$resultAdmin = mysql_query("SELECT * FROM Admin");
			$resultRepresentative = mysql_query("SELECT * FROM Representative");
			$resultProfessor = mysql_query("SELECT * FROM Professor");
			$resultOrganizer = mysql_query("SELECT * FROM Organizer");
			$resultClass = mysql_query("SELECT * FROM Class");
			$resultStudent = mysql_query("SELECT * FROM Student");
			$resultEvent = mysql_query("SELECT * FROM Event");
			$resultVenue = mysql_query("SELECT * FROM Venue");
			$resultActivity = mysql_query("SELECT * FROM Activity");
			$resultPoster = mysql_query("SELECT * FROM Poster");
			$resultClassDay = mysql_query("SELECT * FROM Class_Day");
			$resultClassTime = mysql_query("SELECT * FROM Class_Time");
			$resultProfAttends = mysql_query("SELECT * FROM Prof_Attends");
			$resultStudAttends = mysql_query("SELECT * FROM Stud_Attends");
			$resultHeldAt = mysql_query("SELECT * FROM Held_at");
			$resultHas = mysql_query("SELECT * FROM Has");
			$resultBelongs = mysql_query("SELECT * FROM Belongs");
			$resultProfOrg = mysql_query("SELECT * FROM Prof_Org");
			$resultClassOrg = mysql_query("SELECT * FROM Class_Org");
			$resultHostedby = mysql_query("SELECT * FROM Hostedby");
			$resultManages = mysql_query("SELECT * FROM Manages");
			$resultClasslist = mysql_query("SELECT * FROM Classlist");
			$resultRequires = mysql_query("SELECT * FROM Requires");
			

			echo "<table>
			<tr>
				<th colspan='7' class='title'><u>Admin</u></th>
			</tr>
			<tr>
				<th>user_id</th>
				<th>password</th>
